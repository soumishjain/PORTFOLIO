  ...
  return (
    <div
      className="sticky w-full top-0 h-screen overflow-hidden bg-cover bg-top flex items-center bg-black">
        ...
        <img className="absolute bottom-0 max-md:left-5 left-135 max-md:h-130 h-200" src="https://res.cloudinary.com/mashucloud/image/upload/v1772286880/image_for_portfolio-removebg-preview_pdxcnj.png" alt="" />
